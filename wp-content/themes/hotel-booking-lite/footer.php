	        ...
	        <div class="site-info col-lg-7 col-md-7 col-12">
	            <div class="footer-menu-left">
	            	<?php if(! get_theme_mod('hotel_booking_lite_footer_text_setting') != ''){ ?>
					    <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'hotel-booking-lite' ) ); ?>">
							<?php
					    ...
					    <span>
					       <a target="_blank" href="<?php echo esc_url( __( 'https://www.themagnifico.net/themes/free-hotel-wordpress-theme/', 'hotel-booking-lite' ) ); ?>"> 
					           	<?php
